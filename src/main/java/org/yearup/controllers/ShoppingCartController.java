...
public class ShoppingCartController
{
    ...
    public void addToCart(@PathVariable int productId, Principal principal)
    {
        try
        {
            ...
            e.printStackTrace();
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "Unable to add.");
        }
    }
    ...
    public void updateCartItem(
        ...
        try {
            ...
            shoppingCartDao.updateItem(user.getId(), item);
        }
        catch (Exception e){
            e.printStackTrace();
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "Unable to update");
        }
    }
